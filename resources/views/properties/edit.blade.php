...
<div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            {!! Form::model($property, ['route' => ['properties.update',$property->id], 'method'=>'PUT', 'data-parsley-validate'=>''] ) !!}
                ...
                <select class="form-control" id="company_id" name="company_id" required="">
                    ...
                    @forelse($companies as $index => $company)
                        <option value="{{$company->id}}" {{($company->id==$property->company->id)? 'selected="selected"' : '' }}>{{$company->company_name}}</option>
                    @empty
                ...
                <div class="row form-group">
                    <div class="col-md-6">
                        ...
                        <button type="submit" class="btn btn-success btn-lg btn-block">
                            <i class="glyphicon glyphicon-map-marker"></i> Update
                        </button>
                        </fieldset>
                    </div>
                    <div class="col-md-6">
